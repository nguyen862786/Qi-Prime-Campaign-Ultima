...
export const Route = createFileRoute("/ultima-partnership")({
  head: () => ({
    meta: [
      ...
      <section className="py-16 md:py-24 bg-slate-50 border-b border-slate-200/50">
        <div className="max-w-7xl mx-auto px-4 space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-7 bg-white border border-slate-200 rounded-2xl p-5 sm:p-7 flex flex-col justify-between space-y-6 shadow-sm">
              ...
              {/* Vẽ biểu đồ dạng SVG nét sáng màu xanh emerald */}
              <div className="w-full h-48 sm:h-56 relative bg-slate-50/50 rounded-xl overflow-hidden border border-slate-200">
                <svg className="w-full h-full" viewBox="0 0 400 200" preserveAspectRatio="none">
                  ...
                  {/* Các chấm hiển thị mốc */}
                  <circle cx="100" cy="135" r="4.5" fill="#059669" />
                  <circle cx="200" cy="110" r="4.5" fill="#059669" />
                  <circle cx="300" cy="65" r="4.5" fill="#059669" />
                  <circle cx="400" cy="35" r="5" fill="#059669" className="animate-ping" />
                  <circle cx="400" cy="35" r="5" fill="#059669" />
                </svg>
